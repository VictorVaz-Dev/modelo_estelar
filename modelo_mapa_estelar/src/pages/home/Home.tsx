    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center p-6">
        ...
        <div className="mb-8 flex flex-col items-center ">
          ...
          <p>Uma pequena recordação de como o céu estava exatamente na data, horário e local do nosso momento mais especial: </p>
          <img
            src={starMapImg}
            alt="Mapa estelar"
        ...
        <p className="p-2 text-base">cada momento que passei com você foi unico, aqui estão as fotos de alguns dos nossos momentos, mas com certeza teremos muitos mais durante nossa vida juntos</p>
        <p></p>
